...
class PostgresDB:
    ...
    def AddTable(self) :
        self.cur=self.connectData.cursor()
        self.cur.execute('''CREATE TABLE SerchTimes2(
    ...
    # 修改單一資料
    def ChangeData (self,database_name,data_element,data,target_data_element,target) :
        sql = "UPDATE " + database_name + " SET " + data_element + "=" + data + " WHERE " + target_data_element + "=" + target
        self.cur.execute(sql)
